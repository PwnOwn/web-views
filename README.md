...
一个简约的博客/note网站模板，基于 markdown + obsidian + vitepress
...
做了如下改动
- 精简仓库: 删除了原始的note，较大的文件，思源宋体文件， `.obsidian/`文件夹, `netlify`文件夹
...
额外的 tips
- 对于已有的note和图片链接，你可以考虑使用 obsidian 插件[obsidian-link-converter](https://github.com/ozntel/obsidian-link-converter) 来帮你做自动的转换 `[[wikilink]]` 为 relative_path 的 markdown link
